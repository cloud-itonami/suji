...
(def muscles
  ...
  (array-map
   ...
   {:name "upper_trapezius" :paired? true :pcsa-cm2 9.0
    ...
    :source "representative; suspension line. The insertion rides on the THORAX, not on the humerus: the acromion belongs to the shoulder girdle, and a girdle that rotated with the arm would swing its own suspension line horizontal under abduction and report that the trapezius cannot lift. MAPPING RESOLVED 2026-09-09 by reading the primary in full (Vasavada, ch.3 of Rothman-Simeone The Spine, pp.64-65, which reprints Kamibayashi LK & Richmond FJR, Morphometry of human neck muscles, Spine 23(12):1314-1323, 1998, Table 3-3; obtained 2026-09-07, read in full, not as an abstract): this entry's attachment - occiput and nuchal line to the lateral clavicle - is exactly the CAVOTRAPEZIUS, the rostral segment (pars descendens, skull to clavicle); the two caudal segments the chapter names (acromiotrapezius/pars transversa and spinotrapezius/pars ascendens) attach to the acromion and the scapular spine, which this model does not carry, so the whole entry is the one segment K&R measures. That same table measures the clavotrapezius at 1.96 (0.62) cm2 PER SIDE, range 1.25-2.94, N=10. This entry's 9.0 is NOT taken from the source: it is :representative and exceeds the measured per-side value 4.6x, so the suspender's capacity is OVERSTATED and its scapular-suspension %MVC correspondingly UNDERSTATED (an overstatement, not a direction flip). The value is NOT changed here - replacing 9.0 with the measured 1.96 (per side) or 3.92 (bilateral) would tune the number toward the literature, and that one-line change is reported, not made, the same way the 12.0 -> 3.356 cervical-extensor split is reported in muscle/specs. :pcsa-cm2 stays 9.0 in BOTH tables, so the-pcsa-written-twice-is-written-the-same-twice still holds."}
   ...
   {:name "levator_scapulae" :paired? true :pcsa-cm2 5.0
    ...
    :source "representative; suspension line, on the thorax for the same reason as upper_trapezius — the scapula is not the humerus. MAPPING RESOLVED 2026-09-09 by the same primary read as upper_trapezius (Vasavada ch.3 / Kamibayashi & Richmond 1998 Table 3-3): levator scapulae IS in that table and is measured at 2.18 (0.80) cm2 PER SIDE, range 1.39-3.24, N=8. This entry's 5.0 is NOT taken from the source: it is :representative and exceeds the measured per-side value 2.3x, so its capacity is OVERSTATED and its scapular-suspension %MVC correspondingly UNDERSTATED (an overstatement, not a direction flip). The value is NOT changed here - replacing 5.0 with the measured 2.18 (per side) or 4.36 (bilateral) would tune the number toward the literature, and that one-line change is reported, not made. :pcsa-cm2 stays 5.0 in BOTH tables, so the-pcsa-written-twice-is-written-the-same-twice still holds."}
